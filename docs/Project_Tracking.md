...
**Not yet done this session:** rows 12-16 (still abstract-only), the row #5 duplicate-check (possible match to Yap/Yolland/Tschandl 2018), and the Fitzpatrick-fairness-literature search recommended 2026-07-17.

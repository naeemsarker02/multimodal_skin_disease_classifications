...
## Cell 6 — `%%writefile /kaggle/working/src/models/image_model.py`
...
## Cell 7 — `%%writefile /kaggle/working/src/models/metadata_model.py`
...
## Cell 8 — `%%writefile /kaggle/working/src/models/fusion_model.py`
...
## Cell 9 — `%%writefile /kaggle/working/src/models/cross_attention_fusion_model.py`
...
## Cell 10 — `%%writefile /kaggle/working/src/models/spatial_backbone_embedder.py`

```python
%%writefile /kaggle/working/src/models/spatial_backbone_embedder.py
...
## Cell 12 — `%%writefile /kaggle/working/src/models/train.py`
...
## Cell 14 — Sanity check (config load + both checkpoint sets + real image path resolution)
